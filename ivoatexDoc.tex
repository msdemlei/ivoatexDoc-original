...
unsatisfactory as it is, please commit both \texttt{role_diagram.svg} and
\texttt{role_diagram.pdf} to the version control system.
...
the authors' \texttt{role_diagram.xml}, are ad-hoc XML interpreted by the
